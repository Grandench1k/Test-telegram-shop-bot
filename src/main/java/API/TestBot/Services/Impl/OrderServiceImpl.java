...
public class OrderServiceImpl implements OrderService {
    ...
    public String buyFirstProducts(User user, UserDetails userDetails, int valueOfProducts, int userBalance) {
        ...
        if (valueOfProducts > firstProductList.size()) {
            userDetailsService.userSetBuyingProducts(userDetails, false);
    ...
    public String buySecondProducts(User user, UserDetails userDetails, int valueOfProducts, int userBalance) {
    ...
    public String buyThirdProducts(User user, UserDetails userDetails, int valueOfProducts, int userBalance) {
